...
/* inventory dialog pop up for adding new items
* takes item name and quantity as input
*
* uses OnAddInventoryListener so the parent fragment can insert the item
* into the database and refresh the RecyclerView.
*/
public class InventoryDialogFragment extends DialogFragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (parent instanceof OnAddInventoryListener) {
            mListener = (OnAddInventoryListener) parent;
            return;
        }
